...
export MODEL_PATH="${MODEL_PATH:-${MODEL_ROOT}/Qwen2.5-1.5B-Instruct}"
...
ENV_ARGS=(
    ...
    "++env.validation_concurrency=${VALIDATION_CONCURRENCY}"
...
TRAINER_ARGS=(
    ...
    "trainer.project_name=iclr27_webshop"
    "trainer.experiment_name=sdar_qwen2.5_1.5b"
